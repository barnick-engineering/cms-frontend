...
import { ProductColumns as columns } from './ProductColumns'
import { Input } from '@/components/ui/input'
import type { ColumnFiltersState } from '@tanstack/react-table'
import { DataTableViewOptions } from '@/features/users/components/data-table-view-options'
import { DataTablePagination } from '@/features/users/components/data-table-pagination'
import type { DataTablePropsInterface } from '@/interface/productInterface'
import { DataTableBulkActions } from './DataTableBulkActions'
import { useDebounce } from '../../hooks/useDebounce'
import { NoDataFound } from '../NoDataFound'
import { Card, CardContent } from '../ui/card'

interface ProductTableProps extends DataTablePropsInterface {}
...
const ProductTable = ({
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, _columnId, filterValue) => {
      ...
      return id.includes(searchValue) || name.includes(searchValue) || details.includes(searchValue)
    },
                  ...
                  <Card className='m-4'>
                    <CardContent>
                      <NoDataFound
                        ...
                        details="Create a product first."
                      />
                    </CardContent>
                  </Card>
                </TableCell>
